...
CIMGUI_API void igPushStyleVarImVec2(ImGuiStyleVar idx, ImVec2 val);      // modify a style ImVec2 variable. always use this if you modify the style after NewFrame().
...
CIMGUI_API void  igColumns(void);                                          // Implied count = 1, id = NULL, border = true
CIMGUI_API void  igColumnsEx(int count /* = 1 */, const char* id /* = NULL */, bool border /* = true */);
...
CIMGUI_API void igSetItemDefaultFocus(void);                         // make last item the default focused item of a window.
...
CIMGUI_API bool     igImageButtonImTextureID(ImTextureID user_texture_id, ImVec2 size, ImVec2 uv0 /* = ImVec2(0, 0) */, ImVec2 uv1 /* = ImVec2(1, 1) */, int frame_padding /* = -1 */, ImVec4 bg_col /* = ImVec4(0, 0, 0, 0) */, ImVec4 tint_col /* = ImVec4(1, 1, 1, 1) */); // Use new ImageButton() signature (explicit item id, regular FramePadding)
// OBSOLETED in 1.87 (from February 2022 but more formally obsoleted April 2024)
CIMGUI_API ImGuiKey igGetKeyIndex(ImGuiKey key);                                                                // Map ImGuiKey_* values into legacy native key index. == io.KeyMap[key]. When using a 1.87+ backend using io.AddKeyEvent(), calling GetKeyIndex() with ANY ImGuiKey_XXXX values will return the same value!
